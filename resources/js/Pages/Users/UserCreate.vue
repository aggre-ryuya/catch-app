...
const onCreate = () => {
  userDetail.commission = parseInt(userDetail.commission, 10);
        ...
        <div class="bg-white py-6 sm:py-8 lg:py-12">
          <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form @:submit.prevent class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
              ...
              <div class="sm:col-span-2">
                <label for="commission" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">歩合</label>
                <select id="commission" v-model="userDetail.commission"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  <option>13</option>
                  <option>14</option>
                  <option>15</option>
                </select>
                <p class="text-red-600" v-if="errors.commission">{{ errors.commission[0] }}</p>
              </div>

              <div class="sm:col-span-2">
                <div class="flex">
                  <div class="">
                    <input id="tax-number1" type="radio" value="1" name="tax"
                      v-model="userDetail.tax"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="tax-number1" class="ms-2 text-sm font-medium text-gray-400 dark:text-gray-500">税込み</label>
                  </div>

                  <div class="pl-2">
                    <input checked id="dtax-number2" type="radio" value="0" name="tax"
                      v-model="userDetail.tax"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="dtax-number2" class="ms-2 text-sm font-medium text-gray-400 dark:text-gray-500">税抜き</label>
                  </div>
                </div>
                <p class="text-red-600" v-if="errors.tax">{{ errors.tax[0] }}</p>
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <div class="flex">
                  <div class="">
                    <input id="enabled-radio-1" type="radio" value="1" name="disabled-radio"
                      v-model="userDetail.role"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="enabled-radio-1" class="ms-2 text-sm font-medium text-gray-400 dark:text-gray-500">入力、編集可</label>
                  </div>

                  <div class="pl-2">
                    <input checked id="disabled-radio-2" type="radio" value="0" name="disabled-radio"
                      v-model="userDetail.role"
                      class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="disabled-radio-2" class="ms-2 text-sm font-medium text-gray-400 dark:text-gray-500">閲覧のみ</label>
                  </div>
                </div>
                <p class="text-red-600" v-if="errors.role">{{ errors.role[0] }}</p>
              </div>
              ...
              <div class="flex ">
                ...
                <Link :href="route('UserLists')" as="button"
